# this module Adapted from https://github.com/amdegroot/ssd.pytorch
...
class ToTensor(object):
    def __call__(self, image, boxes, labels):
        return torch.tensor(image), torch.tensor(boxes), torch.tensor(labels)

class PermuteImage(object):
    def __call__(self, image, boxes, labels):
        return image.permute(2, 0, 1), boxes, labels
